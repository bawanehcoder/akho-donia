...
@section('content')
    ...
    <section id="basic-horizontal-layouts">
        <form class="form form-horizontal" action="{{route('dashboard.conditional-deliveries.update',$entity)}}" method="POST"
                ...
                <div class="container p-2">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group ">
                                ...
                                <input type="text" name="title_ar" value="{{old('title_ar')??$entity->title_ar}}" id="title_ar" class="form-control">
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group ">
                                ...
                                <input type="text" name="title_en" value="{{old('title_en')??$entity->title_en}}" id="title_en" class="form-control">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6">
                            ...
                            <select name="zones[]" autocomplete="off" id="zones" class="select2 w-100"
                                ...
                                @foreach($zones ??[] as $zone)
                                    <option
                                        {{ in_array($zone->id, (old('$zones'))??$entity->zone_ids??[]  ) ? 'selected' : '' }} value="{{$zone->id}}">{{$zone->getTitle()}} </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-6">
                            ...
                            <select name="products[]" autocomplete="off" id="products" class="select2 w-100"
                                ...
                                @foreach($products ??[] as $product)
                                    <option
                                        {{ in_array($product->id, (old('$products'))??$entity->items??[]  ) ? 'selected' : '' }} value="{{$product->id}}">{{$product->getTitle()}} </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-6 ">
                            <div class="form-group ">
                                ...
                                <input type="number" step="any" min="0" max="100" name="purchase_value" value="{{old('purchase_value')??$entity->purchase_value}}"
                        ...
                        <div class="col-6 ">
                            <div class="form-group ">
                                ...
                                <input type="number" step="any" min="0" max="100" name="delivery" value="{{old('delivery')??$entity->delivery}}"
                    ...
                    <div class="row mt-4">
                        <div class=" col-6 ">
                            ...
                            <x-flatpickr value="{{old('start_time')??$entity->start_time}}" name="start_time"
                                         show-time time-format="h:i"/>
                        </div>
                        <div class="col-6">
                            <label for="end_time">@langucw('end of reservation')</label>
                            <x-flatpickr value="{{old('end_time')??$entity->end_time}}" name="end_time" show-time
                                         time-format="h:i"/>
                        </div>
                    </div>
