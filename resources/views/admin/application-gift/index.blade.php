...
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard.application-gifts.index') }}">@langucw('application gifts')</a></li>
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('.data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('dashboard.application-gifts.index') }}"
                },
                columns: [{
                        data: 'id',
                        name: 'id'
