...
@section('content')
    ...
    <section id="basic-horizontal-layouts">
        <form class="form form-horizontal" action="{{route('dashboard.sliders.update',$entity)}}" method="POST"
                ...
                <div class="row m-4">
                    ...
                    <div class="col-12">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control" name="url" value='{{ old('url')??$entity->url }}' placeholder="@lang('Description')" />
                            </div>
                        </div>
                    </div>
                    {{-- index --}}
