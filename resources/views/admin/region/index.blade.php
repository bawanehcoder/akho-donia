...
@section('title')
    {{ trans('general.region') }}
@endsection
@section('css')
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard.region.index') }}">{{ trans('general.products_categories') }}</a>
    </li>
    <li class="breadcrumb-item active">{{ trans('general.region') }}</li>
@endsection
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="{{ route('dashboard.region.create') }}" class="btn btn-added"><svg xmlns="http://www.w3.org/2000/svg"
