...
class OrderPolicy
{
    ...
    {
        return $user->can('force_delete_order::invoiced');
    }
    ...
    {
        return $user->can('force_delete_any_order::invoiced');
    }
    ...
    {
        return $user->can('restore_order::invoiced');
    }
    ...
    {
        return $user->can('restore_any_order::invoiced');
    }
    ...
    {
        return $user->can('replicate_order::invoiced');
    }
    ...
    {
        return $user->can('reorder_order::invoiced');
    }
}
