...
class CategoriesOccasionPolicy
{
    ...
    {
        return $user->can('force_delete_categories::occasion');
    }
    ...
    {
        return $user->can('force_delete_any_categories::occasion');
    }
    ...
    {
        return $user->can('restore_categories::occasion');
    }
    ...
    {
        return $user->can('restore_any_categories::occasion');
    }
    ...
    {
        return $user->can('replicate_categories::occasion');
    }
    ...
    {
        return $user->can('reorder_categories::occasion');
    }
}
